variable "mgpolicyassignment_name" {
  type        = string
  description = "The name which should be used for this Policy Assignment. Possible values must be between 3 and 24 characters in length. Changing this forces a new Policy Assignment to be created."
}
...
variable "not_scopes" {
  type        = list(any)
  description = "exclude resources or RG"
  default     = null
}
